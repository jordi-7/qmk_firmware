...
// Alpha=0 Mod=1
#define RGB_BACKLIGHT_ALPHAS_MODS_ROW_0 0b1110000000000001
#define RGB_BACKLIGHT_ALPHAS_MODS_ROW_1 0b1110000000000001
#define RGB_BACKLIGHT_ALPHAS_MODS_ROW_2 0b1111000000000001
#define RGB_BACKLIGHT_ALPHAS_MODS_ROW_3 0b1111000000000011
...
#define RGB_BACKLIGHT_CAPS_LOCK_INDICATOR { .color = { .h = 0, .s = 0 }, .index = 70 }
#define RGB_BACKLIGHT_LAYER_1_INDICATOR { .color = { .h = 0, .s = 0 }, .index = 71 }
